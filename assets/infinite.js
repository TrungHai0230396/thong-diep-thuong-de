...
const CANH = [
  { id: 'vu-tru',     ten: 'mạng vũ trụ',  loai: 'mang',  mau: '#aac4f0', hat: 3.4, day: .85,
    chu: 'Trọng lực kéo vật chất dồn về các sợi, bỏ trống khoảng giữa. Không ai vẽ ra mạng này. Nó là hình còn lại sau khi vật chất chảy đi.' },
  { id: 'no-ron',     ten: 'mạng nơ-ron',  loai: 'nhanh', mau: '#e8c37a', goc: 7, chia: .52, run: .55, day: 1.5, hat: 1.9,
    chu: 'Năm 2020, Vazza và Feletti đem đo mạng này với mạng vũ trụ vừa rồi. Hai bên cùng một mức phức tạp, dù chênh nhau 27 bậc độ lớn.' },
  { id: 'mach-mau',   ten: 'mạch máu',     loai: 'nhanh', mau: '#e0656f', goc: 5, chia: .56, run: .38, day: 2.1, hat: 0,
    chu: 'Chẻ nhỏ dần là cách rẻ nhất để chạm tới từng tế bào. Tới mao mạch chỉ còn tám phần triệu mét, mà riêng chúng đã chiếm hơn 90 phần trăm tổng chiều dài.' },
  { id: 're-cay',     ten: 'rễ cây',       loai: 'nhanh', mau: '#c9a473', goc: 6, chia: .48, run: .34, day: 1.7, hat: 0,
    chu: 'Cùng lý do đó, rễ chẻ ra để chạm tới từng hạt đất. Dittmer đào nguyên một cây lúa mạch đen bốn tháng tuổi: hơn 13 triệu nhánh, nối lại dài 620 cây số.' },
  { id: 'song',       ten: 'sông ngòi',    loai: 'nhanh', mau: '#6fc3e8', goc: 4, chia: .52, run: .46, day: 2.6, hat: 0,
    chu: 'Ở đây dòng chảy ngược lại. Nước gom từ nghìn khe suối về một dòng, tới cửa biển mới toả ra. Cùng một hình, đi theo hai chiều.' },
  { id: 'tia-set',    ten: 'tia sét',      loai: 'nhanh', mau: '#e6dcff', goc: 3, chia: .3,  run: .85, day: 1.3, hat: 0, thang: true,
    chu: 'Sét chẻ nhánh vì nó đang dò đường qua không khí. Chỉ một nhánh chạm được đất, và ngay khi có đường dẫn thì mọi nhánh còn lại tắt.' },
  { id: 'bong-tuyet', ten: 'bông tuyết',   loai: 'nhanh', mau: '#d8ecfa', goc: 6, chia: .42, run: .14, day: 1.4, hat: 1.4, doiXung: 6,
    chu: 'Đầu nhọn thò ra xa hơn nên hứng được nhiều hơi nước hơn, mọc nhanh hơn, rồi lại nhọn thêm. Chính cái vòng đó đẻ ra nhánh, ở đây và ở hầu hết những cảnh vừa qua.' },
];
const N = CANH.length;
