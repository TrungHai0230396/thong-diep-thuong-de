...
Thứ duy nhất được ghi xuống máy là **một con số**: hạt giống riêng của thiết bị, sinh ngẫu nhiên trong lần mở đầu tiên và lưu ở khoá `tdtd.seed`. Nó không phải nội dung, không tích lũy theo thời gian, và chỉ dùng để xáo bộ bài.

Cách chọn lá:

- Hạt giống của máy quyết định thứ tự bộ bài. **Hai người mở cùng một ngày nhận hai thông điệp khác nhau.**
- `cardFor(ngày, hạt giống)` đếm số ngày kể từ mốc 01/01/2026 rồi tra vào bộ bài đó. Cùng một người trong cùng một ngày thì luôn ra cùng một lá, dù tải lại trang hay đóng mở app.
...
**Hệ quả:** trong cùng một ngày, một người mở lại bao nhiêu lần cũng ra đúng lá đó. Đó là chủ ý, không phải lỗi.
...
Chỉ dùng để kiểm tra. Ngày sai định dạng hoặc không có thật (31/02 chẳng hạn) thì app bỏ qua và quay về ngày hôm nay. Lá hiện ra vẫn theo hạt giống của máy này.
